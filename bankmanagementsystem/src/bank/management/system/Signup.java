...
//        add(l11);
	...
	add(dateChooser);
        ...
        t3.setBounds(300,310,400,30);
        add(t3);
        
        l8.setBounds(100,360,200,30);
        add(l8);
        
        r3.setBounds(300,360,100,30);
        add(r3);
        
        r4.setBounds(450,360,100,30);
        add(r4);
        
        r5.setBounds(635,360,100,30);
        add(r5);
        ...
        add(b);
        final Signup aThis = this;
        
        b.addActionListener(aThis); 
